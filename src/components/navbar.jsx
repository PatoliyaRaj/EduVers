    ...
    >
      <div className="w-full mx-auto px-2 ">
        <div className="flex items-center justify-between h-14 sm:h-16 md:h-18 lg:h-20 xl:h-22 ">
          ...
          <div className="hidden lg:flex items-center space-x-4 xl:space-x-6 flex-1 justify-center max-w-3xl xl:max-w-4xl mx-auto px-2 xl:px-4">
            ...
            <div className="flex items-center bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200 hover:border-blue-300 focus-within:border-blue-500 focus-within:ring-4 focus-within:ring-blue-500/10 transition-all duration-300 shadow-sm hover:shadow-lg w-full max-w-xl xl:max-w-2xl ">
              ...
              <div className="relative mr-2">
                ...
                <svg
                  className="absolute right-2 lg:right-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-blue-600 pointer-events-none"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
          ...
          <nav className="hidden lg:flex lg:align-center items-center space-x-1 xl:space-x-1">
            {navLinks.map((link) => (
              <a
                key={link.name}
                href="/"
              ...
              >
                <svg
                  className="w-4 h-4 lg:w-5 lg:h-5 text-slate-500 group-hover:text-blue-500 transition-colors duration-300 "
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        <div className="px-4 sm:px-6 py-6 space-y-6">
          ...
          <nav className="space-y-2 pt-6 border-t border-slate-200/60">
            {navLinks.map((link) => (
              ...
              >
                <svg
                  className="w-5 h-5 text-slate-500 group-hover:text-blue-500 transition-colors duration-300"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
